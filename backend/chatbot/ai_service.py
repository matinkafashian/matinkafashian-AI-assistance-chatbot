    ...
    def _is_question_in_scope(self, question: str, language: str = 'en') -> bool:
        ...
        if (language or 'en').lower() == 'fa':
            scope_keywords += [
                ...
                # تماس
                'تماس', 'تلگرام', 'شماره', 'ایمیل', 'لینکدین', 'اینستاگرام', 'یوتیوب',
                # مدرس
                ...
                # واژه‌های پرسشی رایج
                'چقدر', 'چیست', 'توضیح', 'کمک', 'یاد بگیرم', 'شروع', 'ثبت‌نام', 'ثبت نام',
        ...
        if (language or 'en').lower() == 'fa':
            course_indicators += [
                ...
                'ثبت نام', 'ثبت‌نام', 'تلگرام', 'شماره', 'ایمیل', 'تماس', 'آموزش', 'یادگیری',
                'پروژه', 'کار', 'شغل', 'فریلنس', 'همکاری', 'قبول', 'ایران', 'خارجی', 'بین‌المللی',
                'مشتری', 'کلاینت', 'سفارش', 'درآمد', 'پول', 'آیا', 'چطور', 'چگونه'
            ]
